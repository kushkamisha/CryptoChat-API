...
function showBalances() {
    ...
    contract.balanceOf(address)
        .then(bal =>
            console.log(`Balance of '0xBd670c480DE5F6FE13a649dbc13Ed52A33251edF' is ${web3.utils.fromWei(bal)} Ether`))

    address = '0xbc99f9A7A24252239D318C31De697e38635566E5'
    contract.balanceOf(address)
        .then(bal =>
            console.log(`Balance of '0xbc99f9A7A24252239D318C31De697e38635566E5' is ${web3.utils.fromWei(bal)} Ether`))
}
